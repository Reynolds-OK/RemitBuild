	...
	<div class="super_container">
		...
		<div class="menu trans_400 d-flex flex-column align-items-end justify-content-start">
			...
			<div class="menu_extra">
				<div class="menu_book text-right"><a href="#">Get Home</a></div>
								...
								<div class="row">
									<div class="col">
										<div class="home_content text-center">
											<div class="home_title">A Luxury Accomodation</div>
											<div class="booking_form_container">
												<form action="#" class="booking_form">
													<div class="d-flex flex-xl-row flex-column align-items-start justify-content-start"></div>
													<div><button class="booking_button trans_200">Get Home</button></div>
												</form>
											</div>
										</div>
									</div>
						...
						<div class="home_container">
							<div class="container">
								<div class="row">
									<div class="col">
										<div class="home_content text-center">
											<div class="home_title">Afford Your Own Home</div>
											<div class="booking_form_container">
												<form action="#" class="booking_form">
													<div class="d-flex flex-xl-row flex-column align-items-start justify-content-start"></div>
													<div><button class="booking_button trans_200">Get Home</button></div>
						...
						<div class="home_container">
							<div class="container">
								<div class="row">
									<div class="col">
										<div class="home_content text-center">
											<div class="home_title">Access Quality Service</div>
											<div class="booking_form_container">
												<form action="#" class="booking_form">
													<div class="d-flex flex-xl-row flex-column align-items-start justify-content-start"></div>
													<div><button class="booking_button trans_200">Get Home</button></div>
						...
						<div class="testimonials_slider_container">
							...
							<div class="owl-carousel owl-theme test_slider">
								...
								<div  class="test_slider_item text-center">
									...
									<div class="testimonial_title"><a href="#">Perfect Service</a></div>
								...
								<div  class="test_slider_item text-center">
									<div class="rating rating_5 d-flex flex-row align-items-start justify-content-center"><i></i><i></i><i></i><i></i><i></i></div>
									<div class="testimonial_title"><a href="#">Smooth Work</a></div>
									<div class="testimonial_text">
										<p>Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit amet tellus blandit. Etiam nec odio vestibulum est mattis effic.</p>
									</div>
						...
						<div class="booking_slider_container">
							<div class="owl-carousel owl-theme booking_slider">
								...
								<div class="booking_item">
									...
									<div class="booking_link"><a href="booking.html">Sankofa Housing</a></div>
								</div>
								...
								<div class="booking_item">
									...
									<div class="booking_overlay trans_200"></div>
									<!-- <div class="booking_price">$120/Night</div> -->
									<div class="booking_link"><a href="booking.html">Deluxe Estate</a></div>
								</div>
								...
								<div class="booking_item">
									...
									<div class="booking_overlay trans_200"></div>
									<!-- <div class="booking_price">$120/Night</div> -->
									<div class="booking_link"><a href="booking.html">SS Ventures</a></div>
								</div>
